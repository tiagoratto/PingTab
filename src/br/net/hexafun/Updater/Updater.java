...
package br.net.hexafun.Updater;
...
public class Updater {
	...
	public boolean shouldUpdate(String localVersion, String remoteVersion) {
		localVersion = localVersion.replaceAll("[a-z]", "");
		localVersion = localVersion.replaceAll("[A-Z]", "");
		localVersion = localVersion.replaceAll("\\.", "");
		localVersion = localVersion.replaceAll("\\s", "");
		remoteVersion = remoteVersion.replaceAll("[a-z]", "");
		remoteVersion = remoteVersion.replaceAll("[A-Z]", "");
		remoteVersion = remoteVersion.replaceAll("\\.", "");
		remoteVersion = remoteVersion.replaceAll("\\s", "");
